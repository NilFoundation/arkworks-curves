...
pub struct Fq(pub __zkllvm_field_curve25519_base);

impl const FromFieldConst<__zkllvm_field_curve25519_base> for Fq {
    fn from_field_const(lit: __zkllvm_field_curve25519_base) -> Self {
        Self(lit)
    }
}
...
deref_impl!(Fq, __zkllvm_field_curve25519_base);
...
from_builtin_impl!(Fq, __zkllvm_field_curve25519_base);
