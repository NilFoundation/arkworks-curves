...
pub struct Fr(pub __zkllvm_field_curve25519_scalar);

impl const FromFieldConst<__zkllvm_field_curve25519_scalar> for Fr {
    fn from_field_const(lit: __zkllvm_field_curve25519_scalar) -> Self {
        Self(lit)
    }
}
...
deref_impl!(Fr, __zkllvm_field_curve25519_scalar);
...
from_builtin_impl!(Fr, __zkllvm_field_curve25519_scalar);
...
impl From<BigInt<4>> for Fr {
    #[inline(always)]
    fn from(_int: BigInt<4>) -> Self {
        todo!("conversion from `BigInt<4>` is not implemented for zkLLVM fields yet");
    }
}
...
impl From<Fr> for BigInt<4> {
    #[inline(always)]
    fn from(_fp: Fr) -> Self {
        todo!("conversion into `BigInt<4>` is not implemented for zkLLVM fields yet");
    }
}
