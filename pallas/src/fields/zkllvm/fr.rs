...
impl const FromFieldConst<__zkllvm_field_pallas_scalar> for Fr {
    fn from_field_const(lit: __zkllvm_field_pallas_scalar) -> Self {
        Self(lit)
    }
}
...
from_builtin_impl!(Fr, __zkllvm_field_pallas_scalar);
