...
impl const FromFieldConst<__zkllvm_field_bls12381_base> for Fq {
    fn from_field_const(lit: __zkllvm_field_bls12381_base) -> Self {
        Self(lit)
    }
}
...
from_builtin_impl!(Fq, __zkllvm_field_bls12381_base);
